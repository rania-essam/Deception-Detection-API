...
namespace TruthDetection.DAL.Migrations
{
    ...
    [Migration("20241211173210_user-video")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruthDetection.DAL.Data.Models.Video", b =>
                {
                    ...
                    b.Property<string>("uservideoId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("ID");

                    b.HasIndex("uservideoId");
            ...
            modelBuilder.Entity("TruthDetection.DAL.Data.Models.Video", b =>
                {
                    b.HasOne("TruthDetection.DAL.Data.Models.ApplicationUser", "uservideo")
                        .WithMany("Videos")
                        .HasForeignKey("uservideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
