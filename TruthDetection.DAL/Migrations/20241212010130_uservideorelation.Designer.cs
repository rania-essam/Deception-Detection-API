...
namespace TruthDetection.DAL.Migrations
{
    ...
    [Migration("20241212010130_uservideorelation")]
    partial class uservideorelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TruthDetection.DAL.Data.Models.UserVideo", b =>
                {
                    ...
                    b.HasOne("TruthDetection.DAL.Data.Models.Video", null)
                        .WithOne("uservideo")
                        .HasForeignKey("TruthDetection.DAL.Data.Models.UserVideo", "VideoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
