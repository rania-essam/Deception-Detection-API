...
namespace TruthDetection.DAL.Migrations
{
    ...
    [Migration("20241210065900_imagenameproperty_appuser")]
    partial class imagenameproperty_appuser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruthDetection.DAL.Data.Models.UserVideo", b =>
                {
                    b.Property<int>("VideoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TruthDetection.DAL.Data.Models.Video", b =>
                {
                    ...
                    b.Property<int>("uservideoVideoID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TruthDetection.DAL.Data.Models.Video", b =>
                {
                    ...
                    b.HasOne("TruthDetection.DAL.Data.Models.UserVideo", "uservideo")
                        .WithMany("Videos")
                        .HasForeignKey("uservideoVideoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
